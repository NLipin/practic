...
dockument.getElementById('pause').addEventListener('click', function(){
anim3D1.pause();
anim3D2.pause();
});
dockument.getElementById('play').addEventListener('click', function(){
anim3D1.play();
anim3D2.play();
});
dockument.getElementById('reverse').addEventListener('click', function(){
anim3D1.reverse();
anim3D2.reverse();
});
dockument.getElementById('cansel').addEventListener('click', function(){
anim3D1.cansel();
anim3D2.cansel();
});
